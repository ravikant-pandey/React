...
function Footer() {
  return (
    <footer className="w-full bg-gray-900 text-white py-3 mt-10">
      <div className="container mx-auto max-w-7xl px-6 flex flex-col md:flex-row justify-between items-center md:items-start text-sm space-y-8 md:space-y-0">
        ...
        <div className="text-center md:text-left space-y-2">
          <a href="http://TheTechMind.vercel.app" 
             className="text-xl font-bold text-blue-500 ml-15 hover:underline">
            TheTechMind
          </a>
        ...
        <div className="flex flex-col items-center md:items-end space-y-3">
          <h3 className="text-lg font-semibold text-gray-200 mr-18 hover:underline cursor-pointer">Follow Us</h3>
